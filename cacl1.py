...
class Interpreter(object):
    ...
    def get_next_token(self):
        ...
        This method is responsible for breaking a sentance apart into tokens. One token at a time
        """
        text = self.text
    ...
    def eat(self, token_type):
        ...
        # type and if they match "eat" the current token and
    ...
    def expr(self):
        ...
        self.eat(INTEGER)
        # after the above call the self.current_token is to set
        # EOF token
